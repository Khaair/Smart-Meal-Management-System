...
//     if (btnPrimary.innerHTML == 'Show') {
//         btnPrimary.innerHTML = 'Hide'
//     } else if(btnPrimary.innerHTML =='Hide') {
//         btnPrimary.innerHTML = 'Show'
//     }
   
// });


// btnPrimary.addEventListener('click', () => btnPrimary.innerHTML = 'Clicked')
...
let btnPrimary = document.querySelector('#Toggle');
btnPrimary.addEventListener("click", () => {
    if (btnPrimary.innerHTML == 'Show Details') {
        btnPrimary.innerHTML = 'Hide Details'
    } else if(btnPrimary.innerHTML =='Hide Details') {
        btnPrimary.innerHTML = 'Show Details'
    }
